...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.__labsubtitre = QLabel("Ajouter un host :")
        ...
        self.__fichiername = QPushButton("Relier")
        ...
        self.__lab5.hide()
        self.__text3.hide()
        self.__labnomfichier = QLabel("Nom Fichier")
        grid.addWidget(self.__labtitre, 0, 1)
        grid.addWidget(self.__info, 0, 0)
        grid.addWidget(self.__labadd, 8, 0)
        grid.addWidget(self.__labvide, 6, 0)
        grid.addWidget(self.__btnadd, 8, 2)
        ...
        grid.addWidget(self.__text10, 8, 1)
        ...
        grid.addWidget(self.__labnomfichier, 9, 0)
        grid.addWidget(self.__text11, 9, 1)
        grid.addWidget(self.__fichiername, 9, 2)
        self.__deco.hide()
        self.__info.hide()
